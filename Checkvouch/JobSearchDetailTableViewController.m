//
//  JobSearchDetailTableViewController.m
//  Checkvouch
//
...
@interface JobSearchDetailTableViewController ()

@end

@implementation JobSearchDetailTableViewController
...
-(void)pull_Companies_Three
{
    ...
    if (ref.authData) {
        ...
        [[[ref  queryOrderedByKey] queryEqualToValue: self.job_id]
